...
class EndpointFactory(object):
    ...
    schedules.workweek = SecondaryEndpoint("business_hours/schedules/{}/workweek.json")
    schedules.holidays = PrimaryEndpoint("business_hours/schedules/{}/holidays")
